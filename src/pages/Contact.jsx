...
const Contact = () => {
   ...
   const [currentAnimation, setcurrentAnimation] = useState('second')
   ...
   const handleSubmit = (e) => {
      ...
      emailjs.send(
         ...
         setcurrentAnimation('idle')
         console.log(error);
         showAlert({ show: true, text: 'I didnt receive your message', type: 'dnager' })
   ...
   return (
      <section className="relative flex lg:flex-row flex-col max-container h-[100vh]">
         ...
         <div className="flex-1 min-w-[50%] flex flex-col">
            ...
            <form
               className='w-200 flex flex-col gap-7 mt-14'
